...
class FunticoManager {
    ...
    async signIn() {
        ...
        try {
            ...
            console.log('[Funtico] Callback URL:', window.location.href);
            if (typeof s.signInWithFuntico === 'function') {
                console.log('[Funtico] Redirecting to Funtico login...');
                // Use window.location.href directly like Circuit-Siege
                await s.signInWithFuntico(window.location.href);
            }

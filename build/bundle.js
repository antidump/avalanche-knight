...
class FunticoManager {
    ...
    async signIn() {
        ...
        try {
            const s = this.sdk;
            // Normalize callback URL to registered base URL
            // Remove /build/ path if present, use clean origin URL
            const callbackUrl = window.location.origin + '/';
            console.log('[Funtico] Starting login flow...');
            console.log('[Funtico] Current URL:', window.location.href);
            console.log('[Funtico] Callback URL:', callbackUrl);
    ...
    async signOut() {
        ...
        try {
            const s = this.sdk;
            // Use same normalized URL as signIn
